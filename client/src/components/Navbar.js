        ...
        if (state) {
            return (
                <>
                   ...
                   <li className='nav-item'>
                       <NavLink exact activeClassName='active-page' className="nav-link" to="/Internship">Internships/Courses</NavLink>
                   </li>

                   <li className='nav-item'>
                       <NavLink exact activeClassName='active-page' className="nav-link" to="/JavascriptMastery">JavascriptMastery</NavLink>
                   </li>
