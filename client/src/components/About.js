                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="profile-head">
                                <h5 className='mt-3 text-center'>{userData.name}</h5>
                                <h6 className='mt-3 text-center'>{userData.work}</h6>
                                <p className=" mt-3 text-center mb-5 bg-warning rounded-lg"><Link to="/updateprofile">Edit Profile</Link></p>

                               {/* <button type="button" class="btn btn-light ml-auto  btn-sm"><Link to="/updateprofile">Edit Profile</Link></button> */}
                                ...
                                <ul className="nav nav-tabs" role="tablist">
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Timeline <span class="badge badge-warning">Avail-Soon</span></a>
